...
public class Database extends SQLiteOpenHelper {
    ...
    public Database(Context context) {
        super(context, "ArcTruyen.db", null, 1);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE if not exists taikhoan (\n" +
                ...
                ");\n");
        // insert taikhoan
        db.execSQL("INSERT INTO taikhoan (id, email, matkhau, hoten, dienthoai, diemthuong, loaitk, linkanh) VALUES (1, 'admin@gmail.com', '@Thang123', 'Thang dz', '0123456789', 60, 1, NULL);");
        ...
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (6, 'THẦN HỒN VÕ ĐẾ', 'Đang cập nhật', 'Truyện tranh Thần Hồn Võ Đế được cập nhật nhanh và đầy đủ nhất tại Ark Comic. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ Ark Comic ra các chương mới nhất của truyện Thần Hồn Võ Đế.', 'Cổ Đại', 'https://i.truyenvua.com/ebook/190x247/than-hon-vo-de_1594777337.jpg?gt=hdfgdfg&mobile=2', 0, 'than hon vo de');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (7, 'LĂNG THIÊN THẦN ĐẾ', 'Đang cập nhật', 'Truyện tranh Lăng Thiên Thần Đế được cập nhật nhanh và đầy đủ nhất tại NetTruyen. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ NetTruyen ra các chương mới nhất của truyện Lăng Thiên Thần Đế.', 'Cổ Đại', 'https://i.truyenvua.com/ebook/190x247/lang-thien-than-de_1595742809.jpg?gt=hdfgdfg&mobile=2', 0, 'lang thien than de');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (8, 'TU LA KIẾM TÔN', 'Đang cập nhật', 'Truyện tranh Tu La Kiếm Tôn được cập nhật nhanh và đầy đủ nhất tại NetTruyen. Bạn đọc đừng quên để lại bình luận và chia sẻ, ủng hộ NetTruyen ra các chương mới nhất của truyện Tu La Kiếm Tôn.', 'Cổ Đại', 'https://i.truyenvua.com/ebook/190x247/tu-la-kiem-ton_1584608765.jpg?gt=hdfgdfg&mobile=2', 0, 'tu la kiem ton');");
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (9, 'KHOA KỸ ĐẠI TIÊN TÔNG', 'Đang cập nhật', 'Vốn là học bá IQ cao thời hiện đại, bậc thầy chế tạo thủ công, bởi vì thức đêm làm việc quá sức mà chết, xuyên không đến thế giới tu tiên huyền nguyên đại lục nhập vào thân thể một tên phú nhị đại trong một gia tộc nghèo Tô Cảnh Nghiêu dựa vào tri thức hiện đại, kết hợp với bàn tay vàng bật hack để tu tiên, phi thăng cấp tốc, ở tu tiên giới mở ra những nghiên cứu về sản phẩm khoa học kỹ thuật chấn kinh ánh mắt của đám tu tiên giả, tạo ra một thời đại mới, trở thành đại lão, cùng các mỹ nữ đi lên đỉnh phong nhân sinh Ở học viện đọ sức cùng thiên tài, trở thành nhất bảng top 100; Dẫn đầu học viện tham gia tranh bá, bản thân trở thành đệ nhất nhân của nam vực; lãnh đạo tông môn đánh boss, cuối cùng trở thành truyền thuyết đại lục', 'Harem', 'https://i.truyenvua.com/ebook/190x247/khoa-ky-dai-tien-tong_1623504645.jpg?gt=hdfgdfg&mobile=2', 0, 'khoa ky dai tien tong');");
        ...
        db.execSQL("INSERT INTO truyen (id, tentruyen, tacgia, mota, theloai, linkanh, trangthai, key_search) VALUES (12, 'ĐƯỜNG DẦN TẠI DỊ GIỚI', 'Đang cập nhật', 'Thể loại huyền huyễn dị giới theo nguyên tác của Lục Đạo. Hắn có một thân công phu siêu quần bạt tụy, trong thế giới hiện thực không đất dụng võ, chỉ còn cách làm sát thủ. Tình cờ đến được Dị giới vào thời thế hỗn loạn, trên chiến trường phát huy thực lực. Tên hắn là Đường Dần, chuyện của hắn như chỉ tồn tại trong truyền thuyết...', 'Harem', 'https://www.dtv-ebook.com/images/Cover/33619197821_017668bf28_z.jpg', 1, 'duong dan tai di gioi');");
    ...
    //Tài Khoản
    public void insertNewTaiKhoan(String email, String matkhau, String ten, String dienthoai){
    ...
    public TaiKhoan getTaiKhoan(String email) {
        ...
        if(cursor != null)
            cursor.moveToFirst();
        assert cursor != null;
        return new TaiKhoan(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4),cursor.getInt(5),cursor.getInt(6),cursor.getString(7));
    }
    ...
    public String getEmail(int idtaikhoan){
        SQLiteDatabase db = this.getWritableDatabase();
        String email;
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery("select email from taikhoan where id=?", new String[] {""+idtaikhoan});
        cursor.moveToFirst();
    ...
    public Truyen getTruyenById(int id){
        ...
        cursor.moveToFirst();
        return new Truyen(cursor.getInt(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4),cursor.getString(5), cursor.getInt(6), cursor.getString(7));
    }
    ...
    public Boolean insertNDChapter(String linkanh,int idchapter){
        ...
        long result= db.insert("subchapter",null,values);
        if(result==-1) return false;
        else
            return true;
    }
    ...
    public Boolean deleteNoiDungChapter(int idndc){
        ...
        long kq=db.delete("subchapter","id=?",new String[] {""+idndc});
        if(kq==-1) return false;
        else
            return true;
    }
    ...
    public BinhLuan getThongTinBinhLuan(int id){
        ...
        cursor.moveToFirst();
        return new BinhLuan(cursor.getInt(0),cursor.getInt(1),cursor.getInt(2),cursor.getString(3),cursor.getString(4),cursor.getInt(5));
    }
    ...
    public ThongKe getThongKeById(int id){
        ...
        return new ThongKe(cursor.getInt(0),cursor.getInt(1),cursor.getInt(2),cursor.getFloat(3));
    }
