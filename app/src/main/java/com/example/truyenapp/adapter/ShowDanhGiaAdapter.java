...
public class ShowDanhGiaAdapter extends RecyclerView.Adapter<ShowDanhGiaAdapter.ShowDanhGiaViewHolder>{
    ...
    public static class ShowDanhGiaViewHolder extends RecyclerView.ViewHolder{
        private final TextView tv_tong_tentruyen;
        private final TextView tv_tong_tenchapter;
        private final TextView tv_tong_pl;
        private final TextView tv_tong_ngaydang;
        private final ImageView img_tong_truyen;
