...
public class QLBinhLuanAdapter extends RecyclerView.Adapter<QLBinhLuanAdapter.QLBinhLuanViewHolder>{
    private final ArrayList<BinhLuan> list;
    ...
    public QLBinhLuanViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QLBinhLuanViewHolder(view);
    }
    ...
    public static class QLBinhLuanViewHolder extends RecyclerView.ViewHolder{
        private final TextView tv_id,tv_noidung,tv_trangthai;
        private final Button bt_an,bt_hien;
        private final LinearLayout ll_rcv_qlbinhluan;
