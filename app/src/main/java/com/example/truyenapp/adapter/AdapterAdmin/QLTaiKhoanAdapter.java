...
public class QLTaiKhoanAdapter extends RecyclerView.Adapter<QLTaiKhoanAdapter.QLTaiKhoanViewHolder>{
    ...
    public QLTaiKhoanViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QLTaiKhoanViewHolder(view);
    }
    ...
    public static class QLTaiKhoanViewHolder extends RecyclerView.ViewHolder{
        private final TextView tv_id,tv_email,tv_trangthai;
        private final Button bt_an,bt_hien;
        private final LinearLayout ll_rcv_qltaikhoan;
