...
public class QLTruyenAdapter extends RecyclerView.Adapter<QLTruyenAdapter.QLTruyenViewHolder>{
    ...
    public QLTruyenViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QLTruyenViewHolder(view);
    }
    ...
    public static class QLTruyenViewHolder extends RecyclerView.ViewHolder{
        private final TextView tv_idtruyen,tv_tentruyen;
        private final LinearLayout ll_rcv_qltruyen;
